				...
				<div class="col-sm-5 mx-auto">
					<form method="POST">
						...
						<div class="mb-3">
							...
							<input type="text" name="password" value="<?php echo $data['password']; ?>" placeholder="masukkan password" required class="form-control col-form-label-sm">
						</div>
						<div class="mb-3">
			...
			<div class="row">
				<div class="col-sm-5 mx-auto">
					<form method="POST">
						...
						<div class="mb-3">
							<label class="form-label">Password</label>
							<input type="password" name="password" placeholder="masukkan password" required class="form-control col-form-label-sm">
						</div>
						<div class="mb-3">
							<label class="form-label">Alamat</label>
